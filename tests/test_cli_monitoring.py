...
from compose_farm.cli.monitoring import stats
...
class TestStatsCommand:
    ...
    def test_stats_containers_success(
        ...
        async def mock_fetch_async(cfg: Config) -> list[ContainerStats]:
    ...
    def test_stats_containers_empty(
        ...
        async def mock_fetch_empty(cfg: Config) -> list[ContainerStats]:
            return []
